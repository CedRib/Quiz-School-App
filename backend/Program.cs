...
// builder.Services.AddDbContext<MyContext>(opt => opt.UseSqlite(
...
// ));
builder.Services.AddDbContext<MyContext>(opt => opt.UseMySql(
...
builder.Services.AddScoped(provider => new MapperConfiguration(cfg => {
        cfg.AddProfile(new MappingProfile(provider.GetService<MyContext>()!));
        // see: https://github.com/AutoMapper/AutoMapper.Collection
        cfg.AddCollectionMappers();
        cfg.UseEntityFrameworkCoreModel<MyContext>(builder.Services);
    }).CreateMapper());
